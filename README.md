...
El buscador muestra `Título`, `Detalle`, unidades, valoración, tema y frecuencia, además de la cantidad total o filtrada de series. `Valoración` distingue precios corrientes y constantes sólo cuando los metadatos contienen evidencia inequívoca.
